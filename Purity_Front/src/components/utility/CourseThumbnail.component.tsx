    ...
    // Render while course thumbnail is loading
        function LoadingCourseThumbnail() {
            ...
            <div className={`${styles.course} ${styles.loading}`}>
                ...
                <a className={styles.picture} style={{backgroundImage: `url(${defaultImageURL})`}} data-testid="image"></a>

                <div className={styles.text}>
                    <a className={styles.title} data-testid="title">Loading courses ...</a>
                </div>
    ...
    // Render recieved course thumbnail
        function SuccessCourseThumbnail() {
            ...
            <div className={styles.course}>
                ...
                <a className={styles.picture} style={{backgroundImage: `url(${course!.imageURL ? api.ASSETS + course!.imageURL : defaultImageURL})`}} data-testid="image"></a>

                <span className={styles.price} data-testid="price">{course!.price ? `${course!.price} USD` : 'FREE'}</span>

                <div className={styles.text}>
                    <a className={styles.title} data-testid="title">{course!.title}</a>
                    <p className={styles.about} data-testid="summary">{course!.summary}</p>
                </div>

                <div className={styles.footer}>

                    <a className={`${styles.info} ${styles.category}`} data-testid="category">
                    ...
                    <span className={`${styles.info} ${styles.enrolled}`} data-testid="enrolled">
